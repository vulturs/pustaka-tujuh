<x-layout>
    ...
    {{-- <x-perolehan.perolehan :$perolehan> --}}
    @component('components.perolehan.perolehan', ['perolehan' => $perolehan, 'title' => $title])
        @forelse ($perolehan as $perolehans)
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    {{ $perolehans->id_perolehan }}
                </th>
                <td class="px-6 py-4">
                    {{ $perolehans->nama_sumber }}
                </td>
                <td class="px-6 py-4">
                    {{ $perolehans->no_telp }}
                </td>
                ...
                <td class="px-6 flex py-4 justify-center">
                    <a href="{{ route('edit-perolehan', $perolehans->id_perolehan) }}" button type="button"
                    ...
                    <form action="{{ route('delete-perolehan', $perolehans->id_perolehan) }}" method="POST"
