<x-layout>
    ...
    @component('components.koleksi.edit-koleksi', ['koleksi' => $koleksi])
        @slot('klasifikasi')
        <label>
            <select id="id_klasifikasi" name="id_klasifikasi" value="{{ old('id_klasifikasi') }}" autocomplete="id_klasifikasi" class="input"
                required>
    ...
    @enderror
        ...
        @slot('penerbit')
        <label>
            <select id="id_penerbit" name="id_penerbit" value="{{ old('id_penerbit') }}" autocomplete="id_penerbit" class="input"
                required>
        ...
        @slot('perolehan')
        <label>
            <select id="id_prolehan" name="id_perolehan" value="{{ old('id_perolehan') }}" autocomplete="id_perolehan" class="input"
                required>
