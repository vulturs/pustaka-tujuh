    ...
    <div class="relative mt-10 w-full flex flex-col rounded-lg bg-white bg-clip-border text-gray-700 shadow-lg">
        ...
        <div class="grid lg:grid-cols-2 gap-10 p-6 mb-4 px-10">
            <div class="flex flex-col gap-4">
                <form class="form" method="post" action="{{ route('update-koleksi', $koleksi->kode_buku_induk) }}"
                    ...
                    <label>
                        <input required name="tahun" value="{{ old('tahun', $koleksi->tahun) }}" placeholder=""
                            type="number" min="1900" max="{{ date('Y') }}" class="input">
                    ...
                    <div class="md:flex">
                        <div class="w-full mt-4">
                            <div
                                ...
                                <img id="preview" class="absolute h-full w-full object-contain rounded-lg" />
