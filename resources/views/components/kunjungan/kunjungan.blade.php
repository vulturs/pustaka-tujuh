    ...
    <div class="shadow-md rounded-xl p-4 bg-white dark:bg-gray-900">
        <div class="flex items-center justify-between w-full mb-5">
            <div class="flex w-full justify-between items-baseline">
                <form action="/kunjungan" class="w-80 ml-0 mb-4 flex items-center justify-between">
                    <div class="w-full">
                        <div
                            class="relative rounded-full border border-slate-200 overflow-hidden bg-white drop-shadow-lg w-full">
                            <input type="text" name="search" placeholder="Cari Kunjungan"
                ...
                <div class="flex">
                    ...
                    <a href="{{ route('kunjungan-to-excel') }}?export=xlsx" target="_blank"
