...
<body class="font-body">
    <h1 align="center">Data Pengembalian<br><span style="font-size: 1.2rem">({{ now()->format('d F Y') }})</span></h1>
    <table border="1" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
        <tr>
            <th scope="col" class="px-6 py-3">ID Pengembalian</th>
            ...
            <th scope="col" class="px-6 py-3">Tanggal Dikembalikan</th>
