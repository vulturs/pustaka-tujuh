<x-layout>
    ...
    {{-- <x-pelanggaran.pelanggaran :$pelanggaran> --}}
    @component('components.pelanggaran.pelanggaran', ['pelanggaran' => $pelanggaran, 'title' => $title])
        @forelse ($pelanggaran as $pelanggarans)
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 flex py-4 justify-center">
                    <a href="{{ route('edit-pelanggaran', $pelanggarans->id_pelanggaran) }}" button type="button"
                    ...
                    <form action="{{ route('delete-pelanggaran', $pelanggarans->id_pelanggaran) }}" method="POST"
        ...
        @empty
            <tr>
                <td class="text-center text-mute" colspan="4">Data pelanggaran tidak tersedia</td>
            </tr>
        @endforelse
