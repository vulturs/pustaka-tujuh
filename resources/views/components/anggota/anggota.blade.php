...
<div class="rounded-2xl xl:h-[85vh] overflow-y-auto 2xl:h-[88vh] bg-slate-100 p-5 mb-4">
    <div class="relative shadow-md sm:rounded-lg p-4 bg-white dark:bg-gray-900">
        <div class="flex items-center justify-between mb-5">
            <div class="flex items-baseline">
                <form action="/anggota" class="w-80 ml-0 mb-4 flex items-center justify-between">
                    <div class="w-full">
                        <div
            ...
            <div class="text-right mb-3">
                <a href="{{ route('tambah-anggota') }}"
                    ...
                    Anggota Baru <span class="material-symbols-rounded ps-2 text-sm text-white">
                        add
                    </span>
                    <span
