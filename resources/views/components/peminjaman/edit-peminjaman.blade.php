<x-layout>
    ...
    <div class="p-5 me-4 bg-slate-200 rounded-2xl mb-4">
        <div
            class="relative mt-8 w-1/2 flex flex-col rounded-lg bg-white bg-clip-border text-gray-700 shadow-lg">
            <div
            ...
            <div class="flex flex-col gap-2 p-6">
                        ...
                        <div id="myDropdownBuku"
                            ...
                            @foreach ($koleksiAll as $kolAll)
                                <a href="#" id="cont" data-kode-buku="{{ $kolAll->kode_buku_induk }}"
                                    ...
                                    data-pengarang="{{ $kolAll->pengarang }}"
                                    data-penerbit="{{ $kolAll->nama_penerbit }}" onclick="fillInputsBuku(this);"
                ...
                <form class="form mt-2 mb-2" style="gap: 0; padding-bottom:0;" method="post"
                    ...
                    <div class="flex mb-3 w-full">
                        <div class="">
                            ...
                            <input required class="font-medium text-lg w-80" placeholder="" type="text"
                                id="nama_anggota" name="nama_anggota" value="{{ $pinjam->nama_anggota }}" disabled>
                            <hr style="width: 95%">
                        </div>
                        <div class="w-full">
                            <span class="text-slate-500">Kelas</span><br>
                            <input required class="font-medium text-lg w-full" placeholder="" type="text"
                                id="kelas" name="kelas" value="{{ $pinjam->kelas }}" disabled>
                            <hr>
                        </div>
                    </div>
                ...
                <form class="form" method="post" action="{{ route('update-peminjaman', $pinjam->id_peminjaman) }}">
                    @method('put')
                    @csrf
                    <div class="">
                        <span class="text-slate-500 text-sm">Judul Buku</span><br>
                        <input required class="font-medium w-full border-b-purple-900 text-lg" placeholder=""
                            type="text" id="judul_buku" name="judul_buku" value="{{ $pinjam->judul_buku }}"
                            disabled>
                        <hr>
                    </div>
                    <div class="flex mb-5 w-full">
                        <div class="w-full">
                            ...
                            <input required class="font-medium text-lg w-full" placeholder="" type="text"
                                id="pengarang" name="pengarang" value="{{ $pinjam->pengarang }}" disabled>
                            <hr style="width: 95%">
                        </div>
                        <div class="w-full">
                            <span class="text-slate-500 text-sm">Penerbit</span><br>
                            <input required class="font-medium text-lg w-full" placeholder="" type="text"
                                id="penerbit" name="penerbit" value="{{ $pinjam->nama_penerbit }}" disabled>
                            <hr style="width: 95%">
                        </div>
                        <div class="w-40">
                    ...
                    <div class="flex mb-3 w-full">
                        <div class="me-4">
                            ...
                            <input required class="font-medium text-lg" placeholder="" type="date"
                                id="tanggal_peminjaman" value="{{ $pinjam->tanggal_peminjaman }}"
                        ...
                        <div class="w-full">
                            ...
                            <input required class="font-medium text-lg w-full" placeholder="" type="date"
                                value="{{ $pinjam->tanggal_pengembalian }}" id="tanggal_pengembalian"
                                name="tanggal_pengembalian">
                        </div>
                    </div>

                    <input type="hidden" name="created_by" value="{{ auth()->user()->id_user }}">
                    <input type="hidden" id="id_anggota" value="{{ $pinjam->id_anggota }}" name="id_anggota">
                    <input type="hidden" id="kode_buku_induk" value="{{ $pinjam->kode_buku_induk }}"
                        name="kode_buku_induk">
