<x-layout>
    ...
    @component('components.klasifikasi.klasifikasi', ['title' => $title, 'klasifikasi' => $klasifikasi])
        @forelse ($klasifikasi as $klasi)
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 flex py-4 justify-center">
                    <a href="{{ route('edit-klasifikasi', $klasi->kode_ddc) }}" button type="button"
                    ...
                    <form action="{{ route('delete-klasifikasi', $klasi->kode_ddc) }}" method="POST"
