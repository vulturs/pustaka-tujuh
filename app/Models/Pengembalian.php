...
class Pengembalian extends Model
{
    ...
    {
        $query->leftjoin('data_pinjam', 'pengembalian.id_peminjaman', '=', 'data_pinjam.id_peminjaman')
            ->leftjoin('anggota', 'data_pinjam.id_anggota', '=', 'anggota.id_anggota')
            ->leftjoin('buku_induk', 'data_pinjam.kode_buku_induk', '=', 'buku_induk.kode_buku_induk')
            ->leftjoin('users', 'pengembalian.created_by', '=', 'users.id_user')
            ->leftjoin('pelanggaran', 'pengembalian.id_pelanggaran', '=', 'pelanggaran.id_pelanggaran')
            ->select(
                'pengembalian.*',
                'data_pinjam.id_peminjaman',
                'data_pinjam.tanggal_peminjaman',
                'data_pinjam.batas_pengembalian',
